...
public class MazeState {
    ...
    /**
     * Computes the Manhattan distance between this state and the target state.
     * 
     * @param target A MazeState containing the target state.
     * @return An int corresponding to the Manhattan distance between the states.
     */
    public int getDistance(MazeState target) {
    	return Math.abs(target.col - this.col) + Math.abs(target.row - this.col);
    }
